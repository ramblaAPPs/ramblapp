...
// Función para obtener el último lanzamiento del artista seleccionado
export async function fetchLatestPost(artistId, token) {
  ...
  // Obtener las canciones si es un álbum o compilación
  if (latestRelease.album_type === 'album' || latestRelease.album_type === 'compilation') {
    ...
    latestRelease.tracks = tracksData.items;
  }
